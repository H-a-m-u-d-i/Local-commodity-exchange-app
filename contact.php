...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($farmer_result) > 0 ) {
        ...
        $insert_comment_query = "INSERT INTO comment (full_name, email, comment_text,role) VALUES ('$full_name', '$email', '$comment_text','$role')";
    ...
    } elseif(mysqli_num_rows($buyer_result) > 0 ){
					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Contact</h1>
								<p class="mb-4">Our dedicated team of experts is here to assist you with all your commodity trading needs. If you  have any questions about our platform, we encourage you to reach out to us. You can contact us by phone, email, or by our location listed below. We strive to respond to all inquiries promptly and provide the personalized support you deserve as a valued member of our commodity exchange community. Feel free to get in touch with us anytime, and we will be happy to help however we can.</p>
								<p><a href="shop.php" class="btn btn-secondary me-2">Shop Now</a></p>
							</div>
						</div>
						<div class="col-lg-7">
							<div class="hero-img-wrap">
								<img src="images/imagess/IMG_5887.JPG" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
