...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
    ...
    <h1 style=" text-align: center;">እንኳን ወደ ድህረ_ገጻችን በደህና መጡ(Wellcome to our website)</h1>
    <p style=" font-size: 20px; "> ይህ ድረ_ግጽ የተለያዩ የግብርና ምርቶችን ገበሬዎች ባሉበት ድረስ በመሄድ ምርቶቻቸዉን በመረከብ የገበሬዎችን እንግልት ለመቀነስ
        ታቅዶ የተሰራ ነው።
    እናም ገበሬዎች ባሉበት ሆነው ምርቶቻቸዉን አድራሻችን ድረስ መምጣት ሳይጠበቅባቸው እዚህ ድረ_ገጽ ላይ አሳዉቆ ዉል መፈጸም ይችላሉ። 
    እናም ዉሉን ከፈጸሙ በኋላ ወደ ገብያው መውጣት ሳያስፈልጉዎ ባሉበት ድረስ መጥተን እንረከባቹዋለን።
     አጠቃቀሙ ግራ ካጋባዎት በማነኛዉም ሰዓት ስልካችን ክፍት ነው። ከፈለጉ በቀጥታ በመደወል አሊያም ደሞ በተለያዩ የማህበራዊ ሚዲያዎቻችን በኩል እርዳታ ማግኘት ይችላሉ።

    ማነኛዉም አይነት ምርት አለን ካሉ ከታች ያለዉን ማስፈጠተሪያ በመንካት ቅጹን ይሙሉ ።</p>

   <button class="btn btn-primary" > <a href="farmeru_upload.php" class="text-white">ይህንን ማስፈንጠሪያ ይጫኑ</a></button> 
