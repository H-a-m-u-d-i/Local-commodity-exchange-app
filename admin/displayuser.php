...
echo "<td><a href='delete_buyer.php?buyer_id={$row['buyer_id']}' class='btn btn-primary'>Remove</a></td>";
echo "</tr>";
}
echo "</table>";
} else {
...
echo "<td><a href='deletefarmer.php?farmer_id={$row['farmer_id']}' class='btn btn-primary'>Remove</a></td>";
echo "</tr>";
}
echo "</table>";
} else {
